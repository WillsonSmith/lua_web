...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_exec_lua')) {
        Object.defineProperty(Module['ready'], '_exec_lua', { configurable: true, get: function() { abort('You are getting _exec_lua on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_exec_lua', { configurable: true, set: function() { abort('You are setting _exec_lua on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'lua_loader.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('lua_loader.wasm', import.meta.url).toString();
}
...
var ASM_CONSTS = {
  ...
  function ___syscall_dup2(oldfd, suggestFD) {try {
...
/** @type {function(...*):?} */
var _exec_lua = Module["_exec_lua"] = createExportWrapper("exec_lua");
